...
template <class T>
std::enable_if_t<std::is_fundamental<T>::value, void> print_ip(std::ostream& os, const T &number_)
{
	T number = number_;
...
template <class T>
std::enable_if_t<is_stl_container<T>::value, void> print_ip(std::ostream& os, const T &container)
{
